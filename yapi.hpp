/*
  ...
  Modified for stability and direct address injection.
*/
#pragma once
...
namespace yapi {
	...
	public:
		...
		// [新增] 允许直接传入函数地址的构造函数
		YAPICall(HANDLE hProcess, DWORD64 functionAddress, BOOL isTarget64Bit)
			: _hProcess(hProcess)
			, _sc(0)
			, func(functionAddress)
			, _dw64Ret(FALSE)
			, _dwTimeout(INFINITE)
			, _is64Bit(isTarget64Bit)
		{
		}
